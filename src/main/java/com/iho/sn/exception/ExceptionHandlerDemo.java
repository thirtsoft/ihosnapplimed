...
public class ExceptionHandlerDemo extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDto> profilAlreadyExists(ProfilAlreadyExistsException ex) {
    ...
    public ResponseEntity<ErrorDto> actionNotFound(ActionNotFoundException ex) {
        return new ResponseEntity<>(ErrorDto.builder()
